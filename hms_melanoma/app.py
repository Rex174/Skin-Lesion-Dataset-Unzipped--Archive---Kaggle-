...
SEED_PATIENTS = [
    ...
    ("Maya Krishnan",  45, "female", "V",   -28, "upper extremity", "high",     "bcc",   "+60 16-789 0123", "maya.k@email.com",    "B+",  "Sulfonamides", "2026-04-08", 0.79, "BCC on left forearm. Surgical excision scheduled next month.", "45 Lorong Ampang, 68000 Ampang, Selangor"),
